...
description: "Balanced, practical reasoning mode for everyday requests — coding, debugging, writing, analysis, and routine multi-step tool use. This is the DEFAULT mode: use it unless the request shows real signs of deep ambiguity or high stakes (defer to opus-reasoning), or needs frontier-scale, cross-domain reasoning (defer to fable-reasoning). Most real work lives here."
---
